...
function Synthesis() {
  ...
  function clickedMe(){
    ...
    if (value) {
      //call api
      //set output
      let uri = 'https://api.mantiumai.com/v1/prompt/5e81f081-1fc8-47dc-9de2-2d5dfec4a82b/try?input=' + encodeURIComponent(value);
      ...
      console.log("CRIES IN NOT WORKING CODE")
    }
  }
  
  let handleInputChange = (e: any) => {
    let inputValue = e.target.value;
    setValue(JSON.stringify(inputValue));
  };
/** 
  const headers = {
    "accept": "application/json",
...
*/
  ...
  return (
    ...
    <div>
      ...
      <Input value={value} type="text" name='valuetext' onChange={handleInputChange} />
      <br></br>
      <br></br>
      <Button colorScheme="purple" onClick={clickedMe}> Submit</Button>
      <Center bg="white" h='100px' color='black'>
      <Heading minWidth='10rem' size='md'>
          Summary
        </Heading>
      ...
      <Center bg="white" h='12px' color='black'><div>{output}</div></Center>
...
//ReactDOM.render(<Synthesis />, rootElement);
